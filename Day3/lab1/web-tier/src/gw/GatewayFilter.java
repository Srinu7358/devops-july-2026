...
/**
 * Front door of the web tier. Requests to approved paths are proxied to the
 * app tier. Everything else is blocked here, at the web tier.
 */
...
public class GatewayFilter implements Filter {
    ...
    public void doFilter(ServletRequest sreq, ServletResponse sresp,
        ...
        // Admin endpoint is served locally, never proxied.
